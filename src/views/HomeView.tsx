      ...
      <main className='bg-gray-100 py-10 min-h-screen bg-home' style={{backgroundImage: 'url(/bg.svg)', backgroundRepeat: 'no-repeat', backgroundPosition: 'right', backgroundSize: 'contain'}}>
        <div className='max-w-5xl mx-auto mt-10'>
          <div className='lg:w-1/2 px-10 lg:p-0 space-y-6'>
            ...
            <p className='text-stale-800 text-xl'>Unete a mas de 200 mil developers compartiendo sus redes sociales, comparte tu perfil de TikTok, Facebook, Instragram, Youtube, Github y mas </p>
