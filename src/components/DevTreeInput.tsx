...
type DevTreeInputProps = {
    item: DevTreeLink
    handleUrlChanges: (e: React.ChangeEvent<HTMLInputElement>) => void
...
export default function DevTreeInput({item, handleUrlChanges, handleEnableLink}: DevTreeInputProps) {
  return (
    <div className="bg-white shasow-sm p-5 flex items-center gap-3 cursor-pointer">
        <div 
        ...
        <input type="text" 
                className="flex-1 border border-gray-100 rounden-lg"
                value={item.url}
